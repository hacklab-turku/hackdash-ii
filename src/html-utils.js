...
/*
Originally from matrix-react-sdk (see above copyright notice)
...
import linkifyMatrix from './linkify-matrix.js';
...
export function processHtmlForSending(html) {
...
const transformTags = { // custom to matrix
    ...
    'img': function(tagName, attribs) {
        ...
        attribs.src = window.mxcUrlToHttp(
            attribs.src,
            attribs.width || 800,
            attribs.height || 600,
        );
...
export function bodyToHtml(content, highlights, opts={}) {
    ...
    return isDisplayedWithHtml ?
        { isDisplayedWithHtml, text: safeBody } :
        { isDisplayedWithHtml, text: strippedBody };
}
